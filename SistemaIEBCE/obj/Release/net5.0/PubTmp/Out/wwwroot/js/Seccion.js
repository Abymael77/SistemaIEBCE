...
function cargarDatatable() {
    dataTable = $("#tblSeccion").DataTable({
        "ajax": {
            "url": "/Director/Seccion/GetAll",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            { "data": "id", "width": "5%" },
            { "data": "nomSeccion", "width": "25%" },
            {
                "data": "estado",
            ...
            },
            {
                ...
                "render": function (data) {
                    return `<div class="d-flex justify-content-center flex-nowrap">
                            <a href='/Director/Seccion/Edit/${data}' class='btn btn-outline-primary mr-1' title="Editar">
                            <i class='fas fa-edit'></i>
                            </a>
                            <a onclick="Delete('/Director/Seccion/Delete/${data}')" class='btn btn-outline-danger' title="Eliminar">
