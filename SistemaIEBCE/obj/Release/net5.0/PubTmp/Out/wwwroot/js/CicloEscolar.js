...
function cargarDatatable() {
    dataTable = $("#tblCicloEscolar").DataTable({
        "ajax": {
            ...
            },
            {
                ...
                "render": function (data) {
                    return `<div class="d-flex justify-content-center flex-nowrap">
                            <a href='/Secretario/CicloEscolar/Edit/${data}' class='btn btn-outline-primary mr-1' title="Editar">
                            <i class='fas fa-edit'></i>
                            </a>
                            <a onclick="Delete('/Secretario/CicloEscolar/Delete/${data}')" class='btn btn-outline-danger' title="Eliminar">
                            <i class='fas fa-trash-alt'></i>
                            </a>
                            <a href='/Secretario/CicloEscolar/RepCiclo/${data}' class='btn btn-outline-primary' title="Reporte">
