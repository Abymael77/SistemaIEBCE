...
function cargarDatatable() {
    dataTable = $("#tblCuota").DataTable({
        "ajax": {
            "url": "/Tesorero/Cuota/GetAll",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            { "data": "id", "width": "5%" },
            { "data": "nomCuota", "width": "30%" },
            { "data": "descpCuota", "width": "40%" },
            { "data": "monto", "width": "5%" },
            ...
            },
            {
                ...
                "render": function (data) {
                    return `<div class="d-flex justify-content-center flex-nowrap">
                            <a href='/Tesorero/Cuota/Edit/${data}' class='btn btn-outline-primary mr-1' title="Editar">
                            <i class='fas fa-edit'></i>
                            </a>
                            <a onclick="Delete('/Tesorero/Cuota/Delete/${data}')" class='btn btn-outline-danger' title="Eliminar">
