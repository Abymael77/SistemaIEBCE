...
function cargarDatatable() {
    dataTable = $("#tblBloque").DataTable({
        "ajax": {
            "url": "/Director/Bloque/GetAll",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            { "data": "id", "width": "5%" },
            { "data": "nomBloque", "width": "25%" },
            {
                "data": "estado",
            ...
            },
            {
                ...
                "render": function (data) {
                    return `<div class="d-flex justify-content-center flex-nowrap">
                            <a href='/Director/Bloque/Edit/${data}' class='btn btn-outline-primary mr-1' title="Editar">
                            <i class='fas fa-edit'></i>
                            </a>
                            <a onclick="Delete('/Director/Bloque/Delete/${data}')" class='btn btn-outline-danger' title="Eliminar">
